      ...
      <td key={2}>
        <div>
          <Form.Control
            ...
            type='number'
            size='sm'
            className={'bg-dark ' + validTextColor}
            style={{ color: 'white', border: '0px' }}
            id='daily'
            onChange={(e) => {
              setDaily(parseFloat(e.target.value))
            }}
          ></Form.Control>
        </div>
      </td>
      ...
      <td key={2}>
        <div>
          <Form.Control
            ...
            id='daily'
            onChange={(e) => {
              setComFragments(parseFloat(e.target.value))
            }}
          ></Form.Control>
        </div>
      </td>
